...
public class WebSecurityConfig {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/index.html", "/error", "/login", "/api/raidu/users/register",
                                ...
                                "/api/raidu/users/check-email", "/api/raidu/users/recover"
                                , "/public/**", "/static/**", "/resources/**", "/webjars/**", "/enter/**", "/api/ws/**")
                        .permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(
                Arrays.asList("http://localhost:3000", "http://localhost:5173", "https://i11a108.p.ssafy.io:4443",
