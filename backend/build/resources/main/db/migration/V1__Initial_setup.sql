...
-- 모든 테이블 삭제
DROP TABLE IF EXISTS user_boss_monster;
DROP TABLE IF EXISTS boss_monster;
DROP TABLE IF EXISTS season_user_score;
DROP TABLE IF EXISTS report;
DROP TABLE IF EXISTS user_monster;
DROP TABLE IF EXISTS monster;
DROP TABLE IF EXISTS round_record;
DROP TABLE IF EXISTS exercise_room_record;
DROP TABLE IF EXISTS room_user;
DROP TABLE IF EXISTS room;
DROP TABLE IF EXISTS dictionary;
DROP TABLE IF EXISTS season_region_score;
